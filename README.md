...
4. **Refinement** The submission files are then refined by [HiQBind](https://github.com/THGLab/HiQBind). We also double check if the final output follow the physic rules with ChimeraX (we believe it is necessary but it is not counted on board).
